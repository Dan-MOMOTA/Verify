...
wav:
	#verdi -sv -ntb_opts uvm-\${UVM_VER} -ssf \${WAVE_DIR}/\${tc_full_name}.fsdb -nologo -f \${TB_FILES} -ptrTitle \${TOP_MODULE} &
	verdi -sv -ntb_opts uvm-\${UVM_VER} -nologo -f \${TB_FILES} -ptrTitle \${TOP_MODULE} &
