...
// Creater     :Dan
// Create Date :2025-03-15 22:56:41
...
`ifndef SERDES_INTERFACE_SV
`define SERDES_INTERFACE_SV

class serdes_interface extends uvm_;

    `uvm_component_utils(serdes_interface)
