...
// 
// File Name   :axi_slave_interface.sv
// Creater     :Dan
// Create Date :2025-03-15 22:55:17
...
class axi_slave_interface extends uvm_;

    `uvm_component_utils(axi_slave_interface)
